export default function Loading() {
    return <div className="flex flex-col items-center justify-center max-sm:w-[80%] w-[60%] max-sm:h-[35vh] max-md:h-[45vh] h-[60vh] bg-white/20 backdrop-blur-md shadow-lg rounded-2xl p-16">
