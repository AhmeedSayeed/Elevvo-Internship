...
export default function Testimonial({ name, review}) {
    return <div className="bg-white/20 backdrop-blur-md p-4 rounded-lg shadow-lg text-center flex flex-col items-center gap-6 max-sm:w-[310px] w-[350px] h-[230px] hover:-translate-y-4 transition-all duration-400 ease-in-out">
